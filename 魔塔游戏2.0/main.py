...
def main():
    class Mota:
        def __init__(self):
            ...
            # 导入字体
            self.font = pygame.font.Font("./resources/font/simhei.ttf", 28)
            # 导入音效
            self.yy_bj0 = pygame.mixer.Sound("./resources/sound/0背景音乐.wav")
            self.yy_bj1 = pygame.mixer.Sound("./resources/sound/1背景音乐.wav")
            self.yy_bj13 = pygame.mixer.Sound("./resources/sound/13背景音乐.wav")
            self.yy_bj18 = pygame.mixer.Sound("./resources/sound/18背景音乐.wav")
            self.yy_yx0 = pygame.mixer.Sound("./resources/sound/打击音效.wav")
            self.yy_yx1 = pygame.mixer.Sound("./resources/sound/怪物死亡音效.wav")
            self.yy_yx2 = pygame.mixer.Sound("./resources/sound/获得物品音效.wav")
            self.yy_yx3 = pygame.mixer.Sound("./resources/sound/开门音效.wav")
            self.yy_yx4 = pygame.mixer.Sound("./resources/sound/魔法音效.wav")
            self.yy_yx5 = pygame.mixer.Sound("./resources/sound/升级音效.wav")
            self.yy_yx6 = pygame.mixer.Sound("./resources/sound/提升音效.wav")
            self.yy_yx7 = pygame.mixer.Sound("./resources/sound/不能攻击音效.wav")
            # 导入界面图片
            self.a0 = pygame.image.load("./resources/imgs/jm/a0.png")
            self.a1 = pygame.image.load("./resources/imgs/jm/a1.png")
            self.a2 = pygame.image.load("./resources/imgs/jm/a2.png")
            self.b0 = pygame.image.load("./resources/imgs/jm/b0.png")
            self.b1 = pygame.image.load("./resources/imgs/jm/b1.png")
            self.b2 = pygame.image.load("./resources/imgs/jm/b2.png")
            self.b3 = pygame.image.load("./resources/imgs/jm/b3.png")
            self.c0 = pygame.image.load("./resources/imgs/jm/c0.png")
            self.d0 = pygame.image.load("./resources/imgs/jm/d0.png")
            self.e0 = pygame.image.load("./resources/imgs/jm/e0.png")
            self.f0 = pygame.image.load("./resources/imgs/jm/f0.png")
            self.g0 = pygame.image.load("./resources/imgs/jm/g0.png")
            self.h0 = pygame.image.load("./resources/imgs/jm/h0.png")
            self.i0 = pygame.image.load("./resources/imgs/jm/i0.png")
            self.k0 = pygame.image.load("./resources/imgs/jm/k0.png")
            self.sb = pygame.image.load("./resources/imgs/jm/sb.png")
            # 导入游戏图片
            # 模块化拼接了界面
            self.dx0 = pygame.image.load("./resources/imgs/img/dx0.png")  # 地形设置
            self.gw0 = pygame.image.load("./resources/imgs/img/gw0.png")
            self.js0 = pygame.image.load("./resources/imgs/img/js0.png")
            self.npc0 = pygame.image.load("./resources/imgs/img/npc0.png")
            self.wp0 = pygame.image.load("./resources/imgs/img/wp0.png")
            # 导入对话图片
            self.dh0 = pygame.image.load("./resources/imgs/dh/dh0.png")
            self.jgn0 = pygame.image.load("./resources/imgs/dh/jgn0.png")  # J功能
            self.jgn1 = pygame.image.load("./resources/imgs/dh/jgn1.png")
            self.lgn0 = pygame.image.load("./resources/imgs/dh/lgn0.png")  # l功能
            self.sr0 = pygame.image.load("./resources/imgs/dh/sr0.png")
            self.sr1 = pygame.image.load("./resources/imgs/dh/sr1.png")
            # 设置界面所在位置
            self.jmnum = 0  # 界面判断
            self.jm0num = 569  # 图片滚动初始位置
            ...
            self.dj, self.sm, self.gj, self.fy, self.jb, self.jy, self.ys0, self.ys1, self.ys2 = 0, 1000, 10, 10, 0, 0, 0, 0, 0
            # 设置动态的帧率
            self.clock_s = 0
            ...
            # 测试
            self.lc = 21  # 已经到过的楼层
            self.lpkg = True  # 是否启用该功能
            self.leapgn = True  # 用于是否获得该功能
            self.list_yes = (
        ...
        def pzshezhi(self, xy):  # 碰撞处理
            if self.clock_s % 6 == 0:  # 与速度有关
        ...
        def puvsshezhi(self, gw, xy):  # 普通战斗画面
            sm = self.sm
        ...
        def jmshezhi(self):  # 处理界面的渲染
            if self.jmnum == 0:  # 打开程序的一个文字滚动
                ...
                self.xrshezhi()
                self.fontshezhi()
                self.lpxrshezhi()  # 实现J功能
                self.cxxrshezhi()
                self.puvsshezhi(self.pu_gw, self.pu_xy)  # 普通战斗状态下的渲染
                self.dhshezhi()  # 处理对话信息
                self.shibaishezhi()  # 处理游戏失败后
                self.sdxrshezhi()  # 渲染商店
                self.tsxrshezhi()  # 提示闪烁
                self.yyshezhi()  # 处理音乐

        # 按键功能渲染
        def escshezhi(self):  # 处理退出游戏
            if self.esckg == True:
                root.blit(self.d0, (197, 171), (0, self.escy, 513, 221))

        def f4shezhi(self):  # 处理说明窗口 F4键
            if self.f4kg == True:
                root.blit(self.c0, (0, 0))

        def initshezhi(self):  # 处理重新开始游戏 F5
            if self.initkg == True and self.jmnum == 2:
                root.blit(self.e0, (197, 171), (0, self.f5y, 513, 221))  # 图片素材和esc功能按键一样

        def endshezhi(self):  # 处理游戏通关的画面
        ...
        def shibaishezhi(self):  # 游戏失败后
            if self.swkg == True:
                self.yidongkg = False
                root.blit(self.i0, (0, 0))

        def tsxrshezhi(self):  # 功能键的渲染
            self.clock_ts += 1
            if self.clock_ts <= 60:
        ...
        def rootshezhi(self):  # 实机测试
            while True:
                ...
                self.jmshezhi()
                self.f4shezhi()  # 处理F4功能按键
                self.initshezhi()  # 用于处理重新游戏按钮
                self.endshezhi()  # 处理游戏结束
                self.escshezhi()  # 处理退出游戏按键
    ...
    logo = pygame.image.load("./resources/imgs/logo.png")  # 导入logo图片
